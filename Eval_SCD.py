...
def Eval():
    IMAGE_FORMAT = '.tif'
    IMAGE_FORMAT1 = '.png'  ##JL数据集
    
    # INFER_DIR1 = r'/home/zwenbo/BGSNet-main/BGSNet-main/SECOND_result/BGSNet_v3/BGSNet_HGM+DE+SR_SECOND_100e_316_pred_test/im1/'  # Inference path1
    # INFER_DIR2 = r'/home/zwenbo/BGSNet-main/BGSNet-main/SECOND_result/BGSNet_v3/BGSNet_HGM+DE+SR_SECOND_100e_316_pred_test/im2/'  # Inference path2
    # LABEL_DIR1 = r'/home/zwenbo/SCD-DataSets/SCD-DataSets/test/label1/'  # GroundTruth path
    # LABEL_DIR2 = r'/home/zwenbo/SCD-DataSets/SCD-DataSets/test/label2/'  # GroundTruth path

    INFER_DIR1 = r'/home/zwenbo/BGSNet-main/BGSNet-main/HRSCD_result/BGSNet_HGM+DE+SR_HRSCD_100e_316_pred_test(2)/im1/'  # Inference path1
    INFER_DIR2 = r'/home/zwenbo/BGSNet-main/BGSNet-main/HRSCD_result/BGSNet_HGM+DE+SR_HRSCD_100e_316_pred_test(2)/im2/'  # Inference path2
    LABEL_DIR1 = r'/home/zwenbo/D35/D35/test/label1/'  # GroundTruth path
    LABEL_DIR2 = r'/home/zwenbo/D35/D35/test/label2/'  # GroundTruth path

    infer_list1 = glob.glob(INFER_DIR1 + "*{}".format(IMAGE_FORMAT1))
    infer_list2 = glob.glob(INFER_DIR2 + "*{}".format(IMAGE_FORMAT1))
    ...
    label_list1 = glob.glob(LABEL_DIR1 + "*{}".format(IMAGE_FORMAT1))
    label_list2 = glob.glob(LABEL_DIR2 + "*{}".format(IMAGE_FORMAT1))
    ...
    assert set([(os.path.basename(label))[:-4] for label in label_list1]) == set([(os.path.basename(infer))[:-4] for infer in infer_list1]), "Predictions do not match targets name"
    assert set([(os.path.basename(label))[:-4] for label in label_list2]) == set([(os.path.basename(infer))[:-4] for infer in infer_list2]), "Predictions do not match targets name"
    ...
    for infer, gt in tqdm(zip(infer_list, label_list)):
        ...
        label_array = np.array(label,dtype='uint8')         ###HRSCD数据集
